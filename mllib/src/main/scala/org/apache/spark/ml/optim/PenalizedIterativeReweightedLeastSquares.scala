 ...
 */
private[ml] class PenalizedIterativelyReweightedLeastSquaresModel(
 ...
 */
private[ml] class PenalizedIterativelyReweightedLeastSquares(
  ...
  def fit(instances: RDD[Instance]): PenalizedIterativelyReweightedLeastSquaresModel = {
    ...
    new PenalizedIterativelyReweightedLeastSquaresModel(

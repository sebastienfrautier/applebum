...
class PenalizedIterativelyReweightedLeastSquaresSuite extends SparkFunSuite with MLlibTestSparkContext {
  ...
  test("IRLS against GLM with Binomial errors") {
    ...
    import PenalizedIterativelyReweightedLeastSquaresSuite._
...
object PenalizedIterativelyReweightedLeastSquaresSuite {
